import {isObject} from '@flexio-oss/js-commons-bundle/assert/index.js'
...
export const CLASS_TAG_NAME_ACTION_DISPATCHER = Symbol.for('__HB__ACTION__')
export const CLASS_TAG_NAME_ACTION_SUBSCRIBER = Symbol.for('__HB__ACTION_PUBLIC__')
